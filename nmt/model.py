...
class BaseModel(object):
    ...
    def __init__(self,
        ...
        if self.mode == tf.contrib.learn.ModeKeys.TRAIN:
            ...
            self.infer_logits, _, self.final_context_state, self.sample_id, self.encoder_outputs = res
    ...
    def build_graph(self, hparams, scope=None):
        ...
        with tf.variable_scope(scope or "dynamic_seq2seq", dtype=dtype):
            ...
            return logits, loss, final_context_state, sample_id, encoder_outputs
    ...
    def infer(self, sess):
        ...
        return sess.run([
            self.infer_logits, self.infer_summary, self.sample_id, self.sample_words, self.encoder_outputs
        ])
    ...
    def decode(self, sess):
        ...
        """
        _, infer_summary, _, sample_words, encoder_outputs = self.infer(sess)
        ...
        return sample_words, infer_summary, encoder_outputs
