...
def add_arguments(parser):
    ...
    parser.add_argument("--dump_encoder_output", type="bool", nargs="?", const=True, default=False,
                        help="Whether to dump encoder hidden vectors.")
...
def run_main(flags, default_hparams, train_fn, inference_fn, target_session=""):
    ...
    if flags.inference_input_file:
        ...
        inference_fn(ckpt, flags.inference_input_file,
                     trans_file, hparams, num_workers, jobid, scope=None, dump_encoder_output=flags.dump_encoder_output)
