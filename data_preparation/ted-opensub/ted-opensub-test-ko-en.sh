...
data_dir=/home/hkh/data/ted2013-outdomain/data.ko-en
org_dir=/home/hkh/data/ted2013/data.ko-en
tst2016=tst2016.en-ko
tst2017=tst2017.en-ko

cp ${org_dir}/${tst2016}.tok.ko ${data_dir}/
cp ${org_dir}/${tst2016}.tok.en ${data_dir}/
cp ${org_dir}/${tst2017}.tok.ko ${data_dir}/
cp ${org_dir}/${tst2017}.tok.en ${data_dir}/
