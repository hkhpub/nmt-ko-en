...
#======= EXPERIMENT SETUP ======
NAME=data.ted-opensub.en-ko
DATA_DIR="/home/hkh/data/ted2013/data.ko-en"
OPENSUB_DIR="/home/hkh/data/opensub18/filtered"
...
cat "$DATA_DIR/train.ko-en.tok.clean.$SRC" "$OPENSUB_DIR/filtered.opensub.en-ko.tok.clean.$SRC" > train.merged.$SRC
cat "$DATA_DIR/train.ko-en.tok.clean.$TGT" "$OPENSUB_DIR/filtered.opensub.en-ko.tok.clean.$TGT" > train.merged.$TGT
